...
const Opener = () => {
  return (
    <>
      <Helmet>
        <title>Lega Pauper Livorno - Official Site</title>
        <meta name="description" content="Esplora la Lega Pauper Livorno, un'esauriente rassegna degli eventi e delle curiosità che coinvolgono la nostra ciurma." />
        <meta name="keywords" content="Lega Pauper, eventi, torneo, pirati, Livorno" />
      </Helmet>
